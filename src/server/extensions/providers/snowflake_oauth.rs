  ...
  BLOCKED_ROLES_LIST = ({blocked_roles})"#,
    ...
    async fn handle_creating_oauth_extension(
        ...
        let oauth_spec = crate::server::extensions::providers::oauth::models::OAuthExtensionSpec {
            ...
            // Snowflake doesn't use OIDC, so no issuer for JWKS discovery
            issuer: None,
            // Rise client credentials will be auto-generated by on_spec_updated
            rise_client_id: None,
            rise_client_secret_ref: None,
            rise_client_secret_encrypted: None,
